    ...
    <div className='mb-20'>
      ...
      <div className=' mt-16 flex gap-4 flex-col'>
        <div className='flex gap-4'>
          <div className='w-1/2 h-[400px] bg-base-100 rounded-3xl border-2 p-16'>
            <div className='flex items-center gap-9'>
              <img width={80} src="../assets/images/user1.png" alt="user" />
          ...
          <div className='w-1/2 h-[400px] bg-base-100 rounded-3xl border-2 p-16'>
            <div className='flex items-center gap-9'>
              <img width={80} className="rounded-full" src="../assets/images/user2.png" alt="user" />
        ...
        <div className='flex gap-4'>
          <div className='w-1/2 h-[400px] bg-base-100 rounded-3xl border-2 p-16'>
            <div className='flex items-center gap-9'>
              <img width={80} className="rounded-full" src="../assets/images/user3.png" alt="user" />
          ...
          <div className='w-1/2 h-[400px] bg-base-100 rounded-3xl border-2 p-16'>
            <div className='flex items-center gap-9'>
              <img width={80} className="rounded-full" src="../assets/images/user4.png" alt="user" />
